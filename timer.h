...
#define TIMERCOUNT TIM3->CNT
#define TIMERHANDLE htim3
...
#endif
////////////////////////////////////////////////////////////////////////////
__STATIC_INLINE uint64_t TIMER_getRunTimeus(void) {
...
__STATIC_INLINE int8_t TIMER_uscmptor(uint64_t us, volatile uint64_t *compare, volatile int8_t *state) {
    extern volatile uint64_t time_us;
    extern volatile int8_t flag_timerrupt;
    uint64_t time = 0;
    int8_t result = 0;
